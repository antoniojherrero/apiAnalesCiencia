...
final class EntityRelationsControllerTest extends BaseTestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$writer['id'] = Utils::loadUserData(
            (string) self::$writer['username'],
            (string) self::$writer['email'],
            (string) self::$writer['password'],
            true
        );
        ...
        self::$person  = PersonFactory::createElement(self::$faker->company());
        self::$product  = ProductFactory::createElement(self::$faker->company());
